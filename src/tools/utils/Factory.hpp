...
namespace tools::utils {
    ...
    // class Dependency {
    // public:
    //     Dependency(Factory<T>& factory, const string& type, void* user_data = nullptr): 
    //         factory(factory), type(type), user_data(user_data) {}

    //     T* get(void* owner) {
    //         if (!instance) instance = factory.create(type, user_data);
    //         factory.hold(instance);
    //         return instance;
    //     }

    //     void release(void* owner) {            
    //         if (instance) factory.release(instance);
    //     }
    ...
    // class Owns { // TODO: rename to "Owns"
    // public:
    //     Owns() {}

    //     virtual ~Owns() {
    //         for (auto& [ptr, data] : reserves) data.first(ptr);
    //     }
    ...
    //         reserves[pointer].first = deleter;
    //         return pointer;
    //     }
        
    //     void* reserve(void* owner, void* pointer) {
    //         if (reserves.find(pointer) == reserves.end())
    //             throw ERROR("Cannot reserve unallocated pointer");
    //         reserves[pointer].second.insert(owner);
    //         return pointer;
    //     }

    //     void release(void* owner, void* pointer) {
    //         try {
    //             auto& reserve = reserves.at(pointer); 
    //             auto& owners = reserve.second;
    //             owners.erase(owner);
    //             if (!owners.empty()) return;
    //             reserve.first(pointer);
    ...
    // protected:
    //     unordered_map<void*, pair<function<void(void*)>, unordered_set<void*>>> reserves;
    // };// owns;
